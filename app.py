...
# ==========================================
st.set_page_config(page_title="🚀 Pro AI Trader V4.4", layout="wide", page_icon="🤖")
...
def fetch_live_market_data(coins: list):
    ...
    for coin in coins:
        ...
        # 1. Aşama: MEXC Borsası (Bulut IP'lerine karşı çok daha esnek, limitsiz)
        try:
        ...
        # 2. Aşama: Binance Borsası (Eğer MEXC çökerse yedek olarak dene)
        if not success:
            try:
...
# ==========================================
def main():
    st.title("🚀 Pro AI Trader V4.4 (Multi-Exchange Live)")
    init_system_state()
